 ...
 *
 * This header defines the private interface for the generic Array
 ...
 * should not be used outside the issue in other DS structures. It is an essential part of the DS workflow
 * Historically the wrapper classes were used. But with DIP the functionality was changed to be used as
 * a void array in other DS structures. This is fully enough for this project.
 * DS like Matrix have the strategy pattern applied to use the array with the type casting
 *
 ...
 */
Array *Array_Create(size_t capacity, size_t item_size);
 ...
 * @param arrayFrom the array from which the copy will be made.
 * @return A pointer to the new Array instance.
 */
 ...
 */
void *Array_GetValue(const Array *array, size_t index);
...
*
* This function makes read-only operations on data
*/
